...
if(isset($_POST['post'])){
   ...
   $perch = $_POST['perch'];
   $perch = filter_var($perch, FILTER_SANITIZE_STRING); 
   $age = $_POST['age'];
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="box">
            ...
            <input type="text" name="price" required min="0" max="9999999999" maxlength="50" placeholder="Enter Property Price" class="input">
         </div>
         <div class="box">
         ...
         <div class="box">
            ...
            <select name="type" required class="input">
               ...
               <option value="flat">Residence</option>
         ...
         <div class="box">
            ...
            <select name="bathroom" required class="input">
               ...
               <option value="2">1 Bathroom</option>
               <option value="3">2 Bathroom</option>
               <option value="4">3 Bathroom</option>
               <option value="5">4 Bathroom</option>
               <option value="6">5 Bathroom</option>
               <option value="7">6 Bathroom</option>
               <option value="8">7 Bathroom</option>
               <option value="9">8 Bathroom</option>
               <option value="10">9 Bathroom</option>
            </select>
         </div>
         <div class="box">
         ...
         <div class="box">
            ...
            <input type="text" name="carpet" required min="1" max="9999999999" maxlength="50" placeholder="How Many Squarefits?" class="input">
         </div>
         <div class="box">
            <p>Per Perch Upwards<span>*</span></p>
            <input type="text" name="perch" required min="1" max="9999999999" maxlength="50" placeholder="How Many Perch?" class="input">
         </div>
         <div class="box">
            <p>Property Age <span>*</span></p>
            <input type="text" name="age" required min="0" max="99" maxlength="50" placeholder="How Old is Property?" class="input">
         </div>
         <div class="box">
            <p>Total Floors <span>*</span></p>
            <input type="text" name="total_floors" required min="0" max="99" maxlength="50" placeholder="How Floors Available?" class="input">
         </div>
         <div class="box">
            <p>Floor Room <span>*</span></p>
            <input type="text" name="room_floor" required min="0" max="99" maxlength="50" placeholder="Property Floor Number" class="input">
         </div>
         <div class="box">
            <p>Loan <span>*</span></p>
