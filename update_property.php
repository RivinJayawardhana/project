   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="box">
            ...
            <input type="text" name="price" required min="0" max="9999999999" maxlength="50" value="<?= $fetch_property['price']; ?>" placeholder="Enter property price" class="input">
         </div>
         <div class="box">
         ...
         <div class="box">
            ...
            <input type="text" name="carpet" required min="1" max="9999999999" maxlength="50" placeholder="how many squarefits?" class="input" value="<?= $fetch_property['carpet']; ?>">
         </div>
         <div class="box">
            <p>Property Age <span>*</span></p>
            <input type="text" name="age" required min="0" max="99" maxlength="50" placeholder="how old is property?" class="input" value="<?= $fetch_property['age']; ?>">
         </div>
         <div class="box">
            <p>Total Floors <span>*</span></p>
            <input type="text" name="total_floors" required min="0" max="99" maxlength="50" placeholder="how floors available?" class="input" value="<?= $fetch_property['total_floors']; ?>">
         </div>
         <div class="box">
            <p>Floor Room <span>*</span></p>
            <input type="text" name="room_floor" required min="0" max="99" maxlength="50" placeholder="property floor number" class="input" value="<?= $fetch_property['room_floor']; ?>">
         </div>
         <div class="box">
            <p>Loan <span>*</span></p>
